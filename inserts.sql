...
VALUES (1, 'Mit wie vielen Skiern fährt ein Rennläufer?', 'Noob', 1),
       ...
       (13, 'Hat Lionel Messi oder Cristiano Ronaldo mehr Erfolge erzielt?', 'Medium', 2),
       (14, 'Bei welchem Verein wurde Erling Haaland groß, bevor er zu Dortmund wechselte?', 'Medium', 2),
       ...
       (18, 'Bei welchem Verein hat Cristiano Ronaldo gespielt, bevor er zu Real Madrid ging?', 'Pro', 2),
       ...
       (23, 'Wie viele Spieler sind beim Hallenvolleyball pro Mannschaft vorgesehen?', 'Medium', 3),
...
VALUES (1, 'Mit einem', false, 1),
       ...
       (11, 'Der bekannteste Sportmoderator im ORF', true, 6),
        (12, 'Ein ehemaliger Skirennläufer aus der Zeit Hermann Maiers', false, 6),
       ...
       (15, 'Die Tore beim Riesentorlauf sind noch weiter entfernt voneinander', false, 8),
       ...
       (25, 'Lionel Messi eindeutig mehr mit 98 im Vergleich zu Cristiano Ronaldo mit 67' , true, 13),
        (26, 'Cristiano Ronaldo mit 73 im Vergleich zu Lionel Messi mit 65', false, 13),
       ...
       (31, 'Wenn eine Flanke direkt vor den Torwart gespielt wird und kein Verteidiger mehr davor ist', false, 16),
